...
headers = ["Name", "Air Duel Score", "Ground Attacking Duel Score", "Ground Loose Ball Duel Score", "Acceleration Score", "Body Score",
           "Ground Defending Duel Score (Total Counts)", "Ground Defending Duel Score (Successful Rate)", "Block Shot Score", "Clearance Score", "Defense Score",
...
# 4, 9, 13, 17
for key in scores:
    scores[key].append(scores[key][4] * 0.156978 + scores[key][9] * 0.111305 + scores[key][13] * 0.274037 + scores[key][17] * 0.45768)
